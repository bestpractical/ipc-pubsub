# This Makefile is for the IPC::PubSub extension to perl.
#
...
#     ABSTRACT => q[Interprocess Publish/Subscribe channels]
#     AUTHOR => q[Audrey Tang <cpan@audreyt.org>]
#     DIR => []
#     DISTNAME => q[IPC-PubSub]
#     NAME => q[IPC::PubSub]
#     NO_META => q[1]
#     PL_FILES => {  }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/IPC/PubSub.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/IPC
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/IPC
...
TO_INST_PM = lib/IPC/PubSub.pm \
	...
	lib/IPC/PubSub/Cache/JiftyDBI/Stash/Item.pm \
	lib/IPC/PubSub/Cache/JiftyDBI/Stash/Publisher.pm \
	lib/IPC/PubSub/Cache/Memcached.pm \
	lib/IPC/PubSub/Cache/PlainHash.pm \
	lib/IPC/PubSub/Cacheable.pm \
	lib/IPC/PubSub/Publisher.pm \
	lib/IPC/PubSub/Subscriber.pm

PM_TO_BLIB = lib/IPC/PubSub/Publisher.pm \
	...
	lib/IPC/PubSub/Subscriber.pm \
	blib/lib/IPC/PubSub/Subscriber.pm \
	lib/IPC/PubSub/Cache/JiftyDBI/Stash/Publisher.pm \
	blib/lib/IPC/PubSub/Cache/JiftyDBI/Stash/Publisher.pm \
	lib/IPC/PubSub/Cache/JiftyDBI/Stash.pm \
	blib/lib/IPC/PubSub/Cache/JiftyDBI/Stash.pm \
	lib/IPC/PubSub/Cacheable.pm \
	blib/lib/IPC/PubSub/Cacheable.pm \
	lib/IPC/PubSub/Cache/JiftyDBI/Stash/Item.pm \
	blib/lib/IPC/PubSub/Cache/JiftyDBI/Stash/Item.pm \
	lib/IPC/PubSub/Cache/JiftyDBI.pm \
	blib/lib/IPC/PubSub/Cache/JiftyDBI.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/IPC/PubSub.pm $(INST_MAN3DIR)/IPC::PubSub.$(MAN3EXT) 
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/IPC/PubSub/Publisher.pm blib/lib/IPC/PubSub/Publisher.pm \
	  ...
	  lib/IPC/PubSub/Cache/JiftyDBI/Stash.pm blib/lib/IPC/PubSub/Cache/JiftyDBI/Stash.pm \
	  lib/IPC/PubSub/Cacheable.pm blib/lib/IPC/PubSub/Cacheable.pm \
	  lib/IPC/PubSub/Cache/JiftyDBI/Stash/Item.pm blib/lib/IPC/PubSub/Cache/JiftyDBI/Stash/Item.pm \
	  lib/IPC/PubSub/Cache/JiftyDBI.pm blib/lib/IPC/PubSub/Cache/JiftyDBI.pm 
